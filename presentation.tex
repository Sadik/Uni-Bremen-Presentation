...
\begin{frame}
  ...
  \begin{columns}[T] % align columns
    ...
    \begin{column}{.70\textwidth}
        \only<2->{\includegraphics[width=\textwidth]{images/FSM_opt}}
    \end{column}%
  \end{columns}
\end{frame}
...
\only<2>{\includegraphics[height=0.6\textheight]{images/HTree_opt2}}
\only<3->{\includegraphics[height=0.7\textheight]{images/HTree_opt3}}
\end{column}%
